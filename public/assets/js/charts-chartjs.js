...
(function () {
    ...
    const doughnutChartVar = new Chart(doughnutChart, {
      ...
      data: {
        ...
        datasets: [
          {
            data: [80,10,10],
            backgroundColor: [blueColor,pendiente,orangeLightColor,config.colors.primary],
            borderWidth: 0,
  ...
  const doughnutChartInscripciones = document.getElementById('doughnutChartInscripciones');
  if (doughnutChartInscripciones) {
    const doughnutChartVar = new Chart(doughnutChartInscripciones, {
      type: 'doughnut',
      data: {
        labels: ['Pagado', 'Pendiente', 'Revisión'],
        datasets: [
...
if (pieChart) {
  const pieChartVar = new Chart(pieChart, {
    type: 'pie',
    data: {
      labels: ['Pagado', 'Pendiente', 'Proceso'],
      datasets: [
        {
          data: [60, 30, 10], // Valores para cada sección del gráfico
          backgroundColor: [pagado, pendiente, proceso], // Colores para cada sección
          borderWidth: 1,
          borderColor: '#fff', // Borde blanco entre las secciones
        }
      ]
    },
    options: {

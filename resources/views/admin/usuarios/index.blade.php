...
<div class="card">
    ...
    <div class="card-body">
        <table class="table table-striped tabla_users">
            <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Correo</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <span class="badge rounded-pill bg-warning">Sin Rol</span>
                        @endif
                    </td>
                    <td>
...
@section('js')
<script src="{{asset('assets/sistema/js/usuarioss.js')}}"></script>
<script type="text/javascript" charset="utf-8" async defer>
    $(document).ready(function() {
            var tabla_users = $('.tabla_users');
            var dt = tabla_users.DataTable({
                language: {

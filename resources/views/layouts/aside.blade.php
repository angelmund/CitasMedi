<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-secondary"
    id="sidenav-main">
                ...
                <div class="collapse  show " id="applicationsExamples">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link active" href="../../pages/applications/analytics.html">
                                <span class="sidenav-mini-icon"> A </span>
